    ...
    try {
      ...
      const response =
        await axios.post(
          ...
          'https://airbnb-backend-cpov.onrender.com/api/bookings',
    ...
    try {
      ...
      const response =
        await axios.post(
          ...
          'https://airbnb-backend-cpov.onrender.com/api/favorites',
    ...
    try {
      ...
      const response =
        await axios.post(
          ...
          'https://airbnb-backend-cpov.onrender.com/api/reviews',
